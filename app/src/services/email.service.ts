...
export class EmailService {
        ...
        const htmlContent = `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <div style="text-align: center; margin: 30px 0;">
                    <a href="${confirmUrl}" style="background-color: #2563eb; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px;">Confirmar mi correo</a>
                </div>
    ...
    public static async sendServiceEmail(toEmail: string, token: string): Promise<void> {
        await EmailService.sendVerificationEmail(toEmail, token);
    }
}
