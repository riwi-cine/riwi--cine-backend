...
export interface IfunctionTypeService {
    ...
    findOne(id: number, dto?: Partial<CreateFunctionTypeDto>): Promise<FunctionType | null>;

    update(id: number, dto: Partial<CreateFunctionTypeDto>): Promise<FunctionType | null>;
